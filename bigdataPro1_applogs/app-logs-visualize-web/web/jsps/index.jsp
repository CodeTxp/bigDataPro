  ...
  <script>
      $(function () {
          ...
          $("#a_newusers").click(function(){
              $.getJSON("/stat/weekNewUsers",function(d){
          ...
          //活跃用户统计
          $("#a_activers").click(function(){
              $.getJSON("/stat/weeksActivers",function(d){
                  option.xAxis.data=d.labels;
                  option.series[0].data=d.data;
                  myChart.setOption(option);
              });
          ...
          //沉默用户统计
          $("#a_silenters").click(function(){
              $.getJSON("/stat/daySilenters",function(d){
                  option.xAxis.data=d.labels;
                  option.series[0].data=d.data;
                  myChart.setOption(option);
              });
          ...
          //启动次数
          $("#a_startnum").click(function(){
              $.getJSON("/stat/dayStartNum",function(d){
                  option.xAxis.data=d.labels;
                  option.series[0].data=d.data;
                  myChart.setOption(option);
              });
...
<div id="accordion">
  ...
  <h3>用户分析</h3>
  <div>
    <a id="a_newusers"  href="#"/>周新增用户</a>
    <a id="a_activers" href="#">周活跃用户</a>
    <a id="a_silenters" href="#">今天沉默用户</a>
    <a id="a_startnum" href="#">启动次数</a>
    <a id="a_versions" href="#">版本分布</a>
    <%--<a href="#">行业数据</a>--%>
  </div>
  <h3>用户构成</h3>
  <div>
